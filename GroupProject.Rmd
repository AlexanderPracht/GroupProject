...
model10 <- lm(price_4_nights ~  prop_type_simplified + review_scores_rating + room_type + accommodates + amenities + cancellation_policy + neighbourhood_simplified, data= main_data4)
